...
\headerbox{Projektverlauf }{name=method,column=0,below=objectives,bottomaligned=conclusion, span=2}{ % This block's bottom aligns with the bottom of the conclusion block
