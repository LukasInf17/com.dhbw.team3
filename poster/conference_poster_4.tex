...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=5em]{favicon.png}} % First university/lab logo on the left
...
{\includegraphics[height=5em]{favicon.png}} % Second university/lab logo on the right
...
Im Rahmen eines Modules sollte ein Programm entworfen und ausgearbeitet werden. Für das entwickeln eines Programms gibt es mehrere Anforderung dich zu beachten sind.
...
\headerbox{Idee}{name=introduction,column=1,row=0,bottomaligned=objectives}{
...
\headerbox{Projektverlauf }{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block

Bei der Programmentwicklung können mehrere Arten des Projektmanagements verfolgt werden. So wurde bei diesem Projekt viel Wert auf die agile Projektentwicklung gelegt. Bei diesem System handelt es sich um Scrum.\\
