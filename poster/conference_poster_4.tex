...
{\fontsize{32}{32} \textbf{\textsc{Invite Who you want When you want}}\vspace{0.5em}} % Poster title 
...
\headerbox{Die Idee}{name=results,column=1,span=2,row=0}
{
	...
	Das Programm soll dem Anwender ermöglichen seine Einladungen leichter und effizienter an zahlreiche Gäste zeitgleich zu verschicken.
	So entstand die Idee zu einer Webanwendung zur Verwaltung von Einladungen. Nachlesen kann man die erste Idee auch hier:\\ \url{https://github.com/stuttgart-dhbw/com.dhbw.team3/wiki/Ideenfindung}\\
	\begin{center}
...
\begin{center}
	...
	\captionof{figure}{Test um E-Mail zu überprüfen}
\end{center}
...
\headerbox{Projektverlauf }{name=method,column=0,below=objectives,span=2,aligned=references}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{Methode}{name=results2,column=2,span=1,aligned=method}{ % This block's bottom aligns with the bottom of the conclusion block
}
