...
{\bf\textsc{Implementation of Web Based Invitation Management Sofware}\vspace{0.5em}} % Poster title
...
\headerbox{Idee }{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
